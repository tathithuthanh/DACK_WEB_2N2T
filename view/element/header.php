<div class="container-fluid header">
	<div class="row ">
		<div class="col-md-4">
		<a href="index.php" title="">	<img class="logoimg" src="webroot/img/logo2n2t.png" ></a>
		</div>
		<div class="col-md-3 ">
			...
			<ul class=" menu-l">
				<li class="w"><a href="index.php" title="">Danh Mục <i class="fa fa-angle-down"></i></a>
                    ...
                    while ($row=mysqli_fetch_array($rss)) { ?>	
						<li><a href="/2N2TSHOP/index.php?view=dksanpham&madm=<?php echo $row['MaDM'];?>&t=<?php echo $row['TenDM'] ?>" ><?php echo $row['TenDM'];?></a></li>
					<?php  } ?>
					</ul>
				</li>
				<li class="a2 w"></li>
				<li class="w"><a href="index.php" title="">Sản Phẩm <i class="fa fa-angle-down"></i></a>
                    ...
                    $rss=mysqli_query($conn,$dmsql);                 
                    while ($row=mysqli_fetch_array($rss)) { ?>
						<li><a href="/2N2TSHOP/index.php?view=dksanpham&mancc=<?php echo $row['MaNCC'];?>&t=<?php echo $row['TenNCC'] ?>" ><?php echo $row['TenNCC'];?></a></li>
					 <?php  } ?>
					</ul>
				</li>
				<li class="a2 w"></li>
				<li class="w"><a href="?view=about" title="">ABOUT</a></li>
			</ul>
		</div>
		<div class="col-4 ">
			<ul class="menu-r">
