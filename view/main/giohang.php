...
?>
				<tbody>
					<td class="td"><img class="img-gh" src="/2N2TSHOP/webroot/img/sanpham/<?php echo $kqa['AnhNen'];?>"></td>
					<td class="td2"><a href="index.php?view=chitietsanpham&masp=<?php echo $item_cart['MaSP']; ?>" ><p><?php echo $item_cart['TenSP'];?></p></a>
						...
						<a href="/2N2TSHOP/view/cart/cart_update.php?xoa1=xoa&masp=<?php echo $item_cart['MaSP'];?>&mau=<?php echo $item_cart['Mau'];?>&size=<?php echo $item_cart['Size'];?>"><p>Xóa</p></a>
					</td>
					<td><?php echo number_format($item_cart['DonGia']).' ₫';?></td>
					<td><span class="input-group-btn">
							<a href="/2N2TSHOP/view/cart/cart_update.php?tru=tru&masp=<?php echo $item_cart['MaSP'];?>&mau=<?php echo $item_cart['Mau'];?>&size=<?php echo $item_cart['Size'];?>" title="">
...
<!-- Cộng số lượng -->	<span  class="input-group-btn boder">
							<a href="/2N2TSHOP/view/cart/cart_update.php?cong=cong&masp=<?php echo $item_cart['MaSP'];?>&mau=<?php echo $item_cart['Mau'];?>&size=<?php echo $item_cart['Size'];?>" title="">
...
<?php 	$money=$money+$tt; }
	 ?>
				<?php if(isset($_SESSION['cart_product'])){echo '<td><a href="/2N2TSHOP/view/cart/cart_update.php?xoaall=xoaall" title="">xóa tất cả</a></td>	';}?><th></th><th></th>
