    ...
    <?php  
      ...
      <ul class="pagination justify-content-center">
         <?php for($x=1;$x<=$sotrang;$x++){ ?>
          <li class="page-item">
          	  <a class="page-link" href="/2N2TSHOP/index.php?view=dksanpham&madm=<?php echo $madm;?>&t=<?php echo $t ?>&trang=<?php echo $x ?>&sx=<?php echo $sx1 ?>"><?php echo $x ;?></a></li>
          <?php } ?>
...
<!-- Phân trang -->
    ...
    <?php  
      ...
      <ul class="pagination justify-content-center">
         <?php for($x=1;$x<=$sotrang;$x++){ ?>
          <li class="page-item">
          	  <a class="page-link" href="/2N2TSHOP/index.php?view=dksanpham&mancc=<?php echo $mancc;?>&t=<?php echo $t ?>&trang=<?php echo $x ?>&sx=<?php echo $sx1 ?>"><?php echo $x ;?></a></li>
          <?php } ?>
      </ul>
		<form action="" method="get" accept-charset="utf-8">
