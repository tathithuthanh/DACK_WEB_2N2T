...
<head>
  ...
  <title>2T2N SHOP - Admin</title>

  <link rel="shortcut icon" href="assets/images/favicon.png" />
      <script src="/2N2TSHOP/webroot/jquery/jquery.js"></script>
  <link rel="stylesheet" href="template/css/sb-admin-2.min.css">
  <link href="/2N2TSHOP/webroot/font/Font Awesome/css/all.min.css" rel="stylesheet" type="text/css">
          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block ">
                  <img src="../webroot/img/logogiay1.png" width="450" height="450" >
              </div>
              <div class="col-lg-6">
                <div class="p-5">
