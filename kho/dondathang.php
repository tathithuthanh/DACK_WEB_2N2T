...
<div class="container-fluid">
	<div class="page-header">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - 2N2T SHOES &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Kho Hàng &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Xem Đơn Hàng</h4>
	</div><hr><br>
	<div class="row">
				...
				<tbody>
				 	...
				 	while ($row=mysqli_fetch_array($rs)) { ?>
						<tr>
							...
							<td><a class="nav-link text-info" href="index.php?action=kho&view=chitietdh&mahd=<?php echo $row['MaHD']; ?>" >Chi tiết </a></td>						
						</tr>
		 			<?php	} ?>
				</tbody>
			</table>
